<section class="py-5 bg-primary position-relative overflow-hidden" id="services">
    <div class="services-pattern"></div>
    <div class="container position-relative z-2">
        <div class="text-center mb-5">
            <h2 class="font-serif display-4 fw-bold text-white mb-3">Our Bespoke Services</h2>
            <div class="d-flex align-items-center justify-content-center gap-3">
                <div class="bg-gold" style="width: 48px; height: 1px;"></div>
                <span class="text-gold text-uppercase small">Crafted for Royalty</span>
                <div class="bg-gold" style="width: 48px; height: 1px;"></div>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-md-6 col-lg-4">
                <div class="glass-panel service-card p-4 rounded-3 h-100 position-relative overflow-hidden">
                    ...
                    <p class="text-white-80 small mb-0">Bespoke blouses with intricate hand embroidery, maggam work, and contemporary cuts tailored to your measurements for sarees and traditional wear.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="glass-panel service-card p-4 rounded-3 h-100 position-relative overflow-hidden">
                    ...
                    <p class="text-white-80 small mb-0">Royal bridal lehengas and ghagras with heavy zardosi, velvet textures, and expansive flares, crafted for your wedding day.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="glass-panel service-card p-4 rounded-3 h-100 position-relative overflow-hidden">
                    ...
                    <p class="text-white-80 small mb-0">Custom krutis and chudidar tops with elegant embroidery, perfect pairings with churidars and palazzos for occasions and everyday wear.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="glass-panel service-card p-4 rounded-3 h-100 position-relative overflow-hidden">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="glass-panel service-card p-4 rounded-3 h-100 position-relative overflow-hidden">
                    ...
                    <p class="text-white-80 small mb-0">Comfortable, stylish ethnic wear for children—from parkars and lehengas for weddings and festivals.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="glass-panel service-card p-4 rounded-3 h-100 position-relative overflow-hidden">
                    ...
                    <p class="text-white-80 small mb-0">Expert fitting and alterations so your existing blouses, sarees, and outfits fit perfectly again.</p>
                </div>
            </div>
        </div>
    </div>
